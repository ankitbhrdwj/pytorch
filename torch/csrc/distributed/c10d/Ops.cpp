...
TORCH_LIBRARY(c10d, m) {
  ...
  m.def(
      "allreduce_(Tensor[] tensors, __torch__.torch.classes.c10d.ProcessGroup process_group, __torch__.torch.classes.c10d.ReduceOp reduce_op, Tensor? sparse_indices, int timeout, int tag) -> (Tensor[], __torch__.torch.classes.c10d.Work)");
  m.def(
